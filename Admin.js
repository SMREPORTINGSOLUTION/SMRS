...
async function createReportSelectHTML() {
    try {
        const connectionPresales = await oracledb.getConnection(dbConfigSave);
...
async function createColumnSelectHTML() {
    try {
        const connectionWorkshop = await oracledb.getConnection(dbConfigFetch);
...
async function getReportData() {
    try {
        const connection = await oracledb.getConnection(dbConfigSave);
