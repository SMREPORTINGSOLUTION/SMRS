...
<body>
    ...
    req.on('end', async () => {
        ...
        try {
            ...
            let queryClob = queryResult.rows[0][0];
            let query = '';

            // Read the CLOB data
            if (queryClob) {
                query = await queryClob.getData(); // Using the correct method to get CLOB data as string
            } else {
                throw new Error('No query found in the CLOB field.');
            }

            // Ensure query is a string before using replace
...
<script>
    ...
    function updateTableSelect(data) {
        ...
        <body>
            <nav>
                ...
                <a></a>
                <a href="/create">CREATE</a>
                <a href="/prepare" class="active">PREPARE</a>
                <a href="/admin">VIEW</a>
                <a href="/delete">DELETE</a>
                <a href="/update">UPDATE</a>
				<a href="/dview">DASHBOARDS</a>	
        ...
        res.end(`
			...
			<body>
				<nav>
					...
					<a href="/dprepare">PREPARE QUERY</a>
    ...
    function updateTableSelect(data) {
        ...
        <body>
            <nav>
				...
				<a href="/dview">VIEW DASHBOARDS</a>
				<a href="/dprepare" class="active">PREPARE QUERY</a>
				<a href="/dupdate">UPDATE DASHBOARD</a>
				<a href="/ddelete">DELETE DASHBOARD</a>
				<a href="#" >user: ${username}</a>
				<a href="/logoff" >logout</a>
    ...
    req.on('end', async () => {
		...
		const { optionsHTML, reportData } = await createQuerySelectDashboardHTML();
		const tableColumnData = await userGetTableColumnData();
